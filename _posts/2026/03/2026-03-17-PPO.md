...
## Policy Gradient
<!-- 수식 1 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_1.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
## TRPO
<!-- 수식 2 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_2.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<!-- 수식 3 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_3.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

##  Clipping Policy Probability Rate
<!-- 수식 4 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_4.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<!-- 그림 1 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/graph_1.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

## Min Operation
<!-- 수식 5 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_5.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<!-- 수식 6 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_6.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<!-- 수식 7 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_7.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;예측한 값과 목표 state value의 오차를 줄이도록 학습

- truncate GAE <br>
<!-- 수식 8 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_8.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<!-- 수식 9 -->
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_9.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

- 최종 손실 함수는 다음과 같음. <br>
<p align="center"><img src="{{ '/assets/board/2026/03/photo/formula_10.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<p align="center"><img src="{{ '/assets/board/2026/03/photo/experiment_1.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;대부분의 환경에서 빠르고 높은 reward를 달성하는 것을 확인할 수 있음

<p align="center"><img src="{{ '/assets/board/2026/03/photo/table_1.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
- Roboschool
<p align="center"><img src="{{ '/assets/board/2026/03/photo/experiment_2.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestep에 따라서 reward가 안정적으로 증가하는 것을 확인할 수 있음

- Atari (실험 결과 일부)
<p align="center"><img src="{{ '/assets/board/2026/03/photo/experiment_3.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
